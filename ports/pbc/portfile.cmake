...
if(VCPKG_CMAKE_SYSTEM_NAME)
    ...
    file(COPY ${FILES} ${MPIR_LIBRARIES_REL} DESTINATION "${SOURCE_PATH_PARENT}/mpir/${LibrarySuffix}/${TRIPLET_SYSTEM_ARCH}/Release")
    file(COPY ${FILES} ${MPIR_LIBRARIES_DBG} DESTINATION "${SOURCE_PATH_PARENT}/mpir/${LibrarySuffix}/${TRIPLET_SYSTEM_ARCH}/Debug")
